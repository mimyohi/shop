...
이 약관은 주식회사 미묘히(전자상거래 사업자)가 운영하는 미묘히 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① "몰"이란 주식회사 미묘히가 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
② "이용자"란 "몰"에 접속하여 이 약관에 따라 "몰"이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
③ '회원'이라 함은 "몰"에 회원등록을 한 자로서, 계속적으로 "몰"이 제공하는 서비스를 이용할 수 있는 자를 말합니다.
④ '비회원'이라 함은 회원에 가입하지 않고 "몰"이 제공하는 서비스를 이용하는 자를 말합니다.

제3조 (약관 등의 명시와 설명 및 개정)
① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 미묘히 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
// 개인정보 수집 및 이용 동의
export const PRIVACY_POLICY = `(주)미묘히 개인정보처리방침

(주)미묘히은 (이하 "회사"는) 「개인정보 보호법」 제30조에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.
...
2. 개인정보의 처리 및 보유 기간
(1) 회사는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.
개인정보 처리목적 달성, 정보주체의 서비스 해지 요청이 있을 경우 지체없이 해당 개인정보를 파기합니다.
...
소속 : (주)미묘히
전화번호 : 070-8655-2959
이메일 : official.mimyohi@gmail.com
...
13. 개인정보처리방침 변경
이 개인정보처리방침은 2025년 11월 19일부터 적용됩니다.`;

// 개인정보 수집 및 이용 동의 (간략 버전 - 회원가입 시 표시)
export const PRIVACY_COLLECTION_CONSENT = `개인정보 수집 및 이용에 대한 안내

1. 수집하는 개인정보 항목
- 필수항목: 이메일, 비밀번호, 이름, 휴대전화
- 선택항목: 성별, 생년월일
...
3. 개인정보의 보유 및 이용기간
- 회원탈퇴 시까지
- 단, 관계법령에 따라 일정기간 보존이 필요한 경우 해당 기간 동안 보관

4. 동의를 거부할 권리 및 거부 시 불이익
- 위 개인정보 수집에 대한 동의를 거부할 권리가 있습니다.
- 다만, 필수 항목에 대한 동의를 거부하실 경우 회원가입이 제한됩니다.`;

// 마케팅 정보 수신 동의
export const MARKETING_CONSENT = `마케팅 정보 수신 동의 안내

(주)미묘히에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(SMS) 또는 이메일로 받아보실 수 있습니다.
...
3. 수신동의 변경
- 마이페이지 > 회원정보수정에서 수신동의를 변경하실 수 있습니다.

※ 동의하지 않으셔도 회원가입은 가능하며, 서비스 이용에 제한이 없습니다.`;
